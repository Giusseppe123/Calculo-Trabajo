...
function mostrarJugadoresEnLista(jugadores) {
    ...
    listaJugadores.innerHTML = ""; // Limpia el contenido anterior del contenedor

    // Crear un div para contener a todos los jugadores
    const divContenedor = document.createElement("div");
    divContenedor.classList.add("lista_jugadores_div"); // Clase para el div contenedor

    jugadores.forEach(jugador => {
        // Crear el elemento <li> para cada jugador
        const li = document.createElement("li");
        li.classList.add("lista_jugador"); // Clase para estilo
        ...
        // Añadir cada <li> al div contenedor
        divContenedor.appendChild(li);
    });

    // Añadir el div contenedor al elemento principal
    listaJugadores.appendChild(divContenedor);
}
